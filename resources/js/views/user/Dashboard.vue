    ...
    <div class="pc-content">
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="card statistics-card-1 overflow-hidden">
            <div class="card-body">
              <!-- <img src="/public/assets/images/img-status-5.svg" alt="img" class="img-fluid img-bg" /> -->
        ...
        <div class="col-md-4 col-sm-12">
          <div class="card statistics-card-1 overflow-hidden bg-brand-color-3">
            <div class="card-body">
              <!-- <img src="/public/assets/images/img-status-6.svg" alt="img" class="img-fluid img-bg" /> -->
        ...
        <div class="col-md-6 col-xl-4">
          <div class="card statistics-card-1 overflow-hidden">
            <div class="card-body">
              <!-- <img src="/public/assets/images/img-status-7.svg" alt="img" class="img-fluid img-bg" /> -->
              <div class="d-flex align-items-center">
                <!-- <img src="/public/assets/images/img-facebook.svg" alt="img" class="img-fluid" /> -->
        ...
        <div class="col-md-6 col-xl-4">
          <div class="card statistics-card-1 overflow-hidden">
            <div class="card-body">
              <!-- <img src="/public/assets/images/img-status-8.svg" alt="img" class="img-fluid img-bg" /> -->
              <div class="d-flex align-items-center">
                <!-- <img src="/public/assets/images/img-google.svg" alt="img" class="img-fluid" /> -->
                <div class="flex-grow-1 ms-3">
                  <p class="mb-0 text-muted">Total Likes</p>
                  <div class="d-inline-flex align-items-center">
                    <h5 class="f-w-300 d-flex align-items-center m-b-0">12,281</h5>
        ...
        <div class="col-md-12 col-xl-4">
          <div class="card statistics-card-1 overflow-hidden">
            <div class="card-body">
              <!-- <img src="/public/assets/images/img-status-9.svg" alt="img" class="img-fluid img-bg" /> -->
              <div class="d-flex align-items-center">
                <!-- <img src="/public/assets/images/img-twitter.svg" alt="img" class="img-fluid" /> -->
                <div class="flex-grow-1 ms-3">
                  <p class="mb-0 text-muted">Total Likes</p>
                  <div class="d-inline-flex align-items-center">
                    <h5 class="f-w-300 d-flex align-items-center m-b-0">12,281</h5>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div class="d-inline-block align-middle">
                          <img
                            src="/public/assets/images/user/avatar-4.jpg"
                            alt="user image"
                            class="img-radius align-top m-r-15"
                            style="width: 40px"
                          />
