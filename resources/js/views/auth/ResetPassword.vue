            ...
            <div class="card my-5">
                <div class="card-body">
                    <form @submit.prevent="resetPassword">
                        ...
                        <div class="mb-3">
                            <input type="number" name="verification_code" v-model="user.verification_code" class="form-control" placeholder="221133" />
                            <small v-if="errors.verification_code" class="text-danger" style="color: red;">
                                {{ Array.isArray(errors.verification_code) ? errors.verification_code[0] : errors.verification_code }}
                            </small>
    ...
    setup() {
        ...
        async function resetPassword() {
            try {
                ...
                await authService.resetPassword(state.user);
